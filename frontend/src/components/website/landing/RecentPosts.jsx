        ...
        <div className="row justify-content-between align-items-end mb-40">
          ...
          <div className="col-auto mt-30 mt-md-0">
            <div className="d-flex justify-content-end">
              <a href="services.html" className="w-btn-link">
                View More
                <svg
                  width="14"
                  height="10"
          ...
          <article>
            ...
            >
              ...
              <div className="service-card-content">
                ...
                <div className="d-flex align-items-center service-card-author">
                  <img
                    src="assets/img/avatar/u-sm-2.png"
                    className="service-card-author-img"
                    alt=""
                  />
                  <a
          ...
          <article>
            ...
            >
              ...
              <div className="service-card-content">
                <div className="d-flex align-items-center justify-content-between">
                  <div>
                    <h3 className="service-card-price fw-bold">$30</h3>
                  </div>
                  <div className="d-flex align-items-center gap-1">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                    ...
                    <span className="service-card-rating">5.0 (1k)</span>
                  </div>
                </div>
                <h3 className="service-card-title fw-semibold">
                  <a href="service-details.html">
                    Quomodosoft Agency for UI/UX Agency
                  </a>
                </h3>
                <div className="d-flex align-items-center service-card-author">
                  <img
                    src="assets/img/avatar/u-sm-3.png"
                    className="service-card-author-img"
                    alt=""
                  />
                  <a
          ...
          <article>
            ...
            >
              ...
              <div className="service-card-content">
                ...
                <div className="d-flex align-items-center service-card-author">
                  <img
                    src="assets/img/avatar/u-sm-4.png"
                    className="service-card-author-img"
                    alt=""
                  />
                  <a
